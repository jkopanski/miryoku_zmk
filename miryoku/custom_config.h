...
U_LT(U_BUTTON, Z), Y,     &kp X,             &kp SLASH,             &kp K,             &kp M,             &kp Q,         &kp G,           H, F,\
...
&kp GRAVE,         &kp N1,            &kp N2,            &kp N3,            &kp MINUS,          U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
...
&kp TILDE,         &kp EXCL,          &kp AT,            &kp HASH,          &kp UNDER,          U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
